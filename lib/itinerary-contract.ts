import type { ParsedRequestCategory } from "@/lib/request-types";
import type { Itinerary, ItineraryActionRequest } from "@/lib/itinerary-model";
...
export type CreateItineraryRequest = {
  request?: string;
  parsed?: import("@/lib/request-types").ParsedRequest;
};
