...
- **Optional:** `OPENAI_API_KEY`, `RAPIDAPI_KEY` (OpenTable, hotels, etc.), `GOOGLE_PLACES_API_KEY` (trip page “Top experiences” via Places Text Search), `SERPAPI_KEY` (Google Flights via SerpApi), etc. — see `.env.example`
