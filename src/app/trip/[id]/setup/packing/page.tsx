...
import { TripHostPackingPage } from "@/frontend/components/trip-host-packing-page";
import { normalizePlan } from "@/shared/trip-plan";
import { parseTripPlanStatus } from "@/shared/trip-status";
import { isUuid } from "@/shared/is-uuid";

export default async function TripHostPackingSetupPage({
  params,
}: {
  ...
  if (!user) {
    redirect(`/auth?next=${encodeURIComponent(`/trip/${id}/setup/packing`)}`);
  }
