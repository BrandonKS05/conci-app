...
- **dates.options**: only ranges or phrases the user mentioned (max 3). If no dates, []. Include vague timing they expressed (e.g. “maybe late May”, “June-ish”, “summer”, “flexible in August”) verbatim or minimally paraphrased — months/seasons in these strings steer the calendar the group votes on even when no exact checkout dates exist.
