...
const LOCATION_ALIAS_MAP: Record<string, string[]> = {
  ...
  // Colloquial region/resort names
  cabo: ["cabo san lucas", "los cabos"],
  "los cabos": ["los cabos", "cabo san lucas"],
  hamptons: ["the hamptons", "southampton", "east hampton"],
  "the hamptons": ["the hamptons", "southampton", "east hampton"],
  tulum: ["tulum"],
  bali: ["bali"],
  phuket: ["phuket"],
  ibiza: ["ibiza"],
  ...
  "côte d'azur": ["french riviera", "côte d'azur"],
  alps: ["the alps", "swiss alps"],
